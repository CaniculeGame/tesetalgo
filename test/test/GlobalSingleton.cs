...
namespace test
{
    class GlobalSingleton
    {
        ...
        private Dictionary<int, Personnage> participants = null;

        private GlobalSingleton()
        {
            perso = new Personnage();
            participants = new Dictionary<int, Personnage>();
        }
        ...
        public Dictionary<int,Personnage> Participants { get { return participants; } set { participants = value; } }
    }
}
